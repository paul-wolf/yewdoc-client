...
from yewdoc import YewStore, cli, ls, api, attach, browse, configure, context, convert, create, delete, \
    ...
    def test_take(self):
        ...
        with runner.isolated_filesystem():
            with open('hello.txt', 'w') as f:
                f.write('Hello World!')
            result = runner.invoke(cli, ['--user=test_user', 'take', 'hello.txt', '--force'])
            print(result.output)
