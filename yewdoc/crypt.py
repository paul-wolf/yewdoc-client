...
def export_keys(args):
    ...
    ascii_armored_private_keys = gpg.export_keys(args.key, True, passphrase=args.passphrase)
...
if __name__ == '__main__':
    ...
    parser.add_argument('operation', type=str, default='list', help='operation to perform')
